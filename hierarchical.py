...
def log(msg):
    file = open('./hierarchical/hierarchical_log.txt', 'a')
    file.write(f'{msg} \n')
    file.close()
...
with open('hierarchical/1_case_folded.json', 'w') as outfile:
...
with open('hierarchical/1_case_folded.json') as case_folded_json:
...
with open('hierarchical/2_stemmed_abstracts.json', 'w') as outfile:
    outfile.write(json.dumps(abstracts, sort_keys=True, indent=4))

# Filtering
with open('hierarchical/2_stemmed_abstracts.json') as json_file:
...
with open('hierarchical/3_filtered.json', 'w') as outfile:
    outfile.write(json.dumps(abstracts, sort_keys=True, indent=4))

# Tokenize
nltk.download('punkt')

with open('hierarchical/3_filtered.json') as json_file:
    abstracts = json.load(json_file)
...
with open('hierarchical/4_tokenized.json', 'w') as outfile:
    outfile.write(json.dumps(abstracts, sort_keys=True, indent=4))

# TF
with open('hierarchical/4_tokenized.json') as json_file:
    abstracts = json.load(json_file)
...
with open('hierarchical/5_tf.json', 'w') as outfile:
    outfile.write(json.dumps(abstracts, sort_keys=True, indent=4))
...
with open('hierarchical/6_idf.json', 'w') as outfile:
    outfile.write(json.dumps(abstracts, sort_keys=True, indent=4))

# TF-IDF
with open('hierarchical/6_idf.json') as idf_json:
    idfs = json.load(idf_json)

with open('hierarchical/5_tf.json') as tf_json:
...
with open('hierarchical/7_tfidf.json', 'w') as json_file:
    json_file.write(json.dumps(idfs, sort_keys=True, indent=4))

# Creating dictionary
with open('hierarchical/7_tfidf.json') as json_file:
...
with open('hierarchical/8_dictionary.json', 'w') as outfile:
    outfile.write(json.dumps(words_dict, sort_keys=True, indent=4))

# Replace word with dictionary id
with open('hierarchical/8_dictionary.json') as json_file:
...
with open('hierarchical/9_dictionarized.json', 'w') as outfile:
    outfile.write(json.dumps(documents, sort_keys=True, indent=4))

with open('hierarchical/8_dictionary.json') as json_file:
    dictionary = json.load(json_file)

with open('hierarchical/9_dictionarized.json') as json_file:
    documents = json.load(json_file)
...
sorted_data_frame.to_excel('hierarchical/result.xlsx', index=False)
